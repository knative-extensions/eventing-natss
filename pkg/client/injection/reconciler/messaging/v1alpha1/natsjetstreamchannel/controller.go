...
import (
	...
	versionedscheme "knative.dev/eventing-natss/pkg/client/clientset/versioned/scheme"
	client "knative.dev/eventing-natss/pkg/client/injection/client"
	natsjetstreamchannel "knative.dev/eventing-natss/pkg/client/injection/informers/messaging/v1alpha1/natsjetstreamchannel"
...
const (
	defaultControllerAgentName = "natsjetstreamchannel-controller"
	defaultFinalizerName       = "natsjetstreamchannels.messaging.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	natsjetstreamchannelInformer := natsjetstreamchannel.Get(ctx)

	lister := natsjetstreamchannelInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "messaging.knative.dev.NatsJetStreamChannel"),
	)
