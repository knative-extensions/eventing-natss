...
// controller reconciling v1alpha1.NatsJetStreamChannel.
type Interface interface {
	// ReconcileKind implements custom logic to reconcile v1alpha1.NatsJetStreamChannel. Any changes
	// to the objects .Status or .Finalizers will be propagated to the stored
	// object. It is recommended that implementors do not call any update calls
	// for the Kind inside of ReconcileKind, it is the responsibility of the calling
	// controller to propagate those properties. The resource passed to ReconcileKind
	// will always have an empty deletion timestamp.
	ReconcileKind(ctx context.Context, o *v1alpha1.NatsJetStreamChannel) reconciler.Event
}

// Finalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1alpha1.NatsJetStreamChannel.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1alpha1.NatsJetStreamChannel. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1alpha1.NatsJetStreamChannel) reconciler.Event
}

// ReadOnlyInterface defines the strongly typed interfaces to be implemented by a
// controller reconciling v1alpha1.NatsJetStreamChannel if they want to process resources for which
// they are not the leader.
type ReadOnlyInterface interface {
	// ObserveKind implements logic to observe v1alpha1.NatsJetStreamChannel.
	// This method should not write to the API.
	ObserveKind(ctx context.Context, o *v1alpha1.NatsJetStreamChannel) reconciler.Event
}

type doReconcile func(ctx context.Context, o *v1alpha1.NatsJetStreamChannel) reconciler.Event

// reconcilerImpl implements controller.Reconciler for v1alpha1.NatsJetStreamChannel resources.
type reconcilerImpl struct {
	...
	Lister messagingv1alpha1.NatsJetStreamChannelLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister messagingv1alpha1.NatsJetStreamChannelLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.NatsJetStreamChannels(s.namespace)
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.NatsJetStreamChannel, desired *v1alpha1.NatsJetStreamChannel) error {
	existing = existing.DeepCopy()
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		// The first iteration tries to use the injectionInformer's state, subsequent attempts fetch the latest state via API.
		if attempts > 0 {

			getter := r.Client.MessagingV1alpha1().NatsJetStreamChannels(desired.Namespace)
		...
		updater := r.Client.MessagingV1alpha1().NatsJetStreamChannels(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.NatsJetStreamChannel, desiredFinalizers sets.Set[string]) (*v1alpha1.NatsJetStreamChannel, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.NatsJetStreamChannel, desiredFinalizers sets.Set[string]) (*v1alpha1.NatsJetStreamChannel, error) {
	...
	patcher := r.Client.MessagingV1alpha1().NatsJetStreamChannels(resource.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.NatsJetStreamChannel, desiredFinalizers sets.Set[string]) (*v1alpha1.NatsJetStreamChannel, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1alpha1.NatsJetStreamChannel) (*v1alpha1.NatsJetStreamChannel, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.NatsJetStreamChannel, reconcileEvent reconciler.Event) (*v1alpha1.NatsJetStreamChannel, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
	...
	if err != nil {
		...
		getter := r.Client.MessagingV1alpha1().NatsJetStreamChannels(resource.Namespace)
