...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.NatsJetStreamChannel, desiredFinalizers sets.String) (*v1alpha1.NatsJetStreamChannel, error) {
	// Don't modify the informers copy.
