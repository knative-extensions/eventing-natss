...
// controller finalizing v1alpha1.NatsJetStreamChannel if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1alpha1.NatsJetStreamChannel.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1alpha1.NatsJetStreamChannel) reconciler.Event
}
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.NatsJetStreamChannel, desired *v1alpha1.NatsJetStreamChannel) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.NatsJetStreamChannel) (*v1alpha1.NatsJetStreamChannel, error) {

	getter := r.Lister.NatsJetStreamChannels(resource.Namespace)
