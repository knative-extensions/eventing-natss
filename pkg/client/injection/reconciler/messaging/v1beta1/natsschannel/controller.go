...
import (
	...
	natsschannel "knative.dev/eventing-natss/pkg/client/injection/informers/messaging/v1beta1/natsschannel"
...
const (
	defaultControllerAgentName = "natsschannel-controller"
	defaultFinalizerName       = "natsschannels.messaging.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	natsschannelInformer := natsschannel.Get(ctx)

	lister := natsschannelInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "messaging.knative.dev.NatssChannel"),
	)
