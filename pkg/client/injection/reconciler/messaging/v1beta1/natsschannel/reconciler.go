...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1beta1.NatssChannel, desired *v1beta1.NatssChannel) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.NatssChannel, desiredFinalizers sets.Set[string]) (*v1beta1.NatssChannel, error) {
	// Don't modify the informers copy.
