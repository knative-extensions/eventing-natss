...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.NatssChannel, desiredFinalizers sets.String) (*v1beta1.NatssChannel, error) {
	// Don't modify the informers copy.
