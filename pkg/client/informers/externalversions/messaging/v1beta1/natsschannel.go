...
import (
	...
	messagingv1beta1 "knative.dev/eventing-natss/pkg/apis/messaging/v1beta1"
	...
	v1beta1 "knative.dev/eventing-natss/pkg/client/listers/messaging/v1beta1"
)
...
type NatssChannelInformer interface {
	...
	Lister() v1beta1.NatssChannelLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MessagingV1beta1().NatssChannels(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MessagingV1beta1().NatssChannels(namespace).Watch(context.TODO(), options)
			},
		},
		&messagingv1beta1.NatssChannel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *natssChannelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&messagingv1beta1.NatssChannel{}, f.defaultInformer)
}

func (f *natssChannelInformer) Lister() v1beta1.NatssChannelLister {
	return v1beta1.NewNatssChannelLister(f.Informer().GetIndexer())
}
