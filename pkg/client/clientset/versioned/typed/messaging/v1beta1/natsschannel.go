...
type NatssChannelInterface interface {
	Create(ctx context.Context, natssChannel *v1beta1.NatssChannel, opts v1.CreateOptions) (*v1beta1.NatssChannel, error)
	Update(ctx context.Context, natssChannel *v1beta1.NatssChannel, opts v1.UpdateOptions) (*v1beta1.NatssChannel, error)
	UpdateStatus(ctx context.Context, natssChannel *v1beta1.NatssChannel, opts v1.UpdateOptions) (*v1beta1.NatssChannel, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.NatssChannel, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.NatssChannelList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.NatssChannel, err error)
...
func newNatssChannels(c *MessagingV1beta1Client, namespace string) *natssChannels {
...
func (c *natssChannels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.NatssChannel, err error) {
	result = &v1beta1.NatssChannel{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *natssChannels) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.NatssChannelList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.NatssChannelList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("natsschannels").
...
func (c *natssChannels) Create(ctx context.Context, natssChannel *v1beta1.NatssChannel, opts v1.CreateOptions) (result *v1beta1.NatssChannel, err error) {
	result = &v1beta1.NatssChannel{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("natsschannels").
...
func (c *natssChannels) Update(ctx context.Context, natssChannel *v1beta1.NatssChannel, opts v1.UpdateOptions) (result *v1beta1.NatssChannel, err error) {
	result = &v1beta1.NatssChannel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("natsschannels").
...
func (c *natssChannels) UpdateStatus(ctx context.Context, natssChannel *v1beta1.NatssChannel, opts v1.UpdateOptions) (result *v1beta1.NatssChannel, err error) {
	result = &v1beta1.NatssChannel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("natsschannels").
...
func (c *natssChannels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.NatssChannel, err error) {
	result = &v1beta1.NatssChannel{}
