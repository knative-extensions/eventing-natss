...
func (c *MessagingV1beta1Client) NatssChannels(namespace string) NatssChannelInterface {
	return newNatssChannels(c, namespace)
}
...
// NewForConfigAndClient creates a new MessagingV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*MessagingV1beta1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
