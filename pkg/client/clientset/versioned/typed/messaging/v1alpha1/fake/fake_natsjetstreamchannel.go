...
var natsjetstreamchannelsResource = v1alpha1.SchemeGroupVersion.WithResource("natsjetstreamchannels")

var natsjetstreamchannelsKind = v1alpha1.SchemeGroupVersion.WithKind("NatsJetStreamChannel")
