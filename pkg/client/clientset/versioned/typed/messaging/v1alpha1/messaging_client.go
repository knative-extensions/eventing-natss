...
func (c *MessagingV1alpha1Client) NatsJetStreamChannels(namespace string) NatsJetStreamChannelInterface {
	return newNatsJetStreamChannels(c, namespace)
}
...
// NewForConfigAndClient creates a new MessagingV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*MessagingV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := messagingv1alpha1.SchemeGroupVersion
