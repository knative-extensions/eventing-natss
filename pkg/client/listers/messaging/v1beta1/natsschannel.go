...
// List lists all NatssChannels in the indexer.
func (s *natssChannelLister) List(selector labels.Selector) (ret []*v1beta1.NatssChannel, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.NatssChannel))
	})
	return ret, err
}
...
// List lists all NatssChannels in the indexer for a given namespace.
func (s natssChannelNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.NatssChannel, err error) {
...
// Get retrieves the NatssChannel from the indexer for a given namespace and name.
func (s natssChannelNamespaceLister) Get(name string) (*v1beta1.NatssChannel, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("natsschannel"), name)
	}
	return obj.(*v1beta1.NatssChannel), nil
}
